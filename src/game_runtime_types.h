...
#define RVA_EQUIPMENT_FROM_ITEM_NAME 0x2E0850u // SpawnDatabase/Equipment helper: Construct a generated equipment value from an item key...
...
#define CATDATA_DISORDER_0_OFFSET 0x960u // Disorder slot #0 string key identifier...
#define CATDATA_DISORDER_0_LEVEL_OFFSET 0x980u // Disorder slot #0 native rank value (initialized to 1)...
#define CATDATA_DISORDER_1_OFFSET 0x988u // Disorder slot #1 string key identifier...
#define CATDATA_DISORDER_1_LEVEL_OFFSET 0x9A8u // Disorder slot #1 native rank value (initialized to 1)...
#define CATDATA_EQUIPMENT_HEAD_OFFSET 0x9B0u // Equipment slot loaded from equipment.head...
#define CATDATA_EQUIPMENT_FACE_OFFSET 0xA10u // Equipment slot loaded from equipment.face...
#define CATDATA_EQUIPMENT_NECK_OFFSET 0xA70u // Equipment slot loaded from equipment.neck...
#define CATDATA_EQUIPMENT_WEAPON_OFFSET 0xAD0u // Equipment slot loaded from equipment.weapon...
#define CATDATA_EQUIPMENT_TRINKET_OFFSET 0xB30u // Equipment slot loaded from equipment.trinket...
#define CATDATA_EQUIPMENT_SIZE 0x60u
#define EQUIPMENT_OWNED_STRING_0_OFFSET 0x08u
#define EQUIPMENT_OWNED_STRING_1_OFFSET 0x28u
...
#define CATDATA_DISORDER_COUNT 2U
...
/*
* Use the game's own generator so item generation stays consistent with ordinary character equipment loading...
*/
typedef struct Equipment
{
    uint8_t opaque[CATDATA_EQUIPMENT_SIZE];
} Equipment;
...
typedef Equipment* (__fastcall* fn_equipment_from_item_name)(void* unusedDatabase, Equipment* outEquipment, NarrowString* itemName);
